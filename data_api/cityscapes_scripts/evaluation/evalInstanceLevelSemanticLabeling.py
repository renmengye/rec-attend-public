...
if 'CITYSCAPES_SPLIT' in os.environ:
    args.cityscapesSplit = os.environ['CITYSCAPES_SPLIT']
else:
    args.cityscapesSplit = 'val'

# Parameters that should be modified by user
args.exportFile         = os.path.join( args.cityscapesPath , "evaluationResults" , "resultInstanceLevelSemanticLabeling.json" )
args.groundTruthSearch  = os.path.join( args.cityscapesPath , "gtFine" ,
        args.cityscapesSplit , "*", "*_gtFine_instanceIds.png" )
